# Android Architecture README

## Building

The Android consists of a multi-module Gradle-based project, which can be found under the AndroidArchitecture folder

The project has three different modules  
* /appfoundry-app - The Android application with instrumentation tests using Espresso
* /appfoundry-core - A plain Java module which could allocate Java code such as HttpRequests, JSON parsers, model classes, etc. and runs JUnit tests
